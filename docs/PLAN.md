...
| How much adaptation pressure should the rank-128 product lane use? | with mature Oja and `pp=1/ns=5` fixed, `qvtpskn2` separated matrix LR `4e-4` from fallback LR `1e-4` and reached `1.672156 / 3.037444` target/source at 1k, versus beta-.95 `3e-4` reference `6gkm9k8h` at `1.685367 / 3.022996` | select matrix `4e-4` and fallback `1e-4`: the stronger target adaptation costs a visible but proportionate source trade without applying the matrix pressure to norms and biases |
