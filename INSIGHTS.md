...
- Side/rank policy evaluation (200 steps, 4096 tokens/step, broad-no-embeddings, random init, equal ~89 MB state budget): module-role side beat shape `AUTO` on target val (`1.600` vs `1.810`). Size-rank under budget (`79.7 MB`) performed best (`1.591`). Module-role rank matched uniform rank but exceeded budget clamp. Uniform rank at AUTO side was worst (`1.810`). Peak VRAM identical at ~8.18 GB across all configs — activation memory from long sequences, not policy choice.
